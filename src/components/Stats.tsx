...
const stats = [
  { value: 316, suffix: "B+", label: "Trx Scanned" },
  { value: 20, suffix: "M+", label: "Nasabah Terlindungi" },
  { value: 215, suffix: "B+", label: "YTD Transactions" },
];
...
const StatItem = ({ stat, startCounting }: { stat: typeof stats[0]; startCounting: boolean }) => {

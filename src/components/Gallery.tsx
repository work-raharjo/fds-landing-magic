...
const galleryImages = [
  { src: gallery1, alt: "BNI Tower Jakarta" },
  { src: gallery2, alt: "BRI Building" },
  { src: gallery3, alt: "BNI Heritage Building" },
  { src: gallery4, alt: "BCA Tower" },
];
  ...
  return (
    <section id="gallery" className="section-padding border-t border-border">
      <div className="container-custom">
        <div className="mb-12">
          <h2 className="text-label mb-4 text-xl font-medium text-primary">{t("gallery.title")}</h2>
        </div>

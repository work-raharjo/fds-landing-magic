    ...
    <section id="services" className="section-padding border-t border-border">
      <div className="container-custom">
        <div className="grid lg:grid-cols-[300px_1fr] gap-12 lg:gap-20">
          {/* Section Title */}
          <div>
            <h2 className="text-display-lg sticky top-24">SERVICES</h2>
          </div>
              ...
              <div key={index} className="border-t border-border">
                ...
                >
                  <div className="flex gap-8">
                    ...
                    <h3 className="text-xl md:text-2xl font-display font-medium group-hover:text-accent transition-colors duration-300">
                      {service.title}
                    </h3>
                  </div>
